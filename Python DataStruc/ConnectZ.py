        ...
        def check_player_win(matrix, row_index, col_index, z, playerlst):
            for player in playerlst:
                ...
                if len(horizontal_list[0]) >= z:
                    result = checkConsecutive(horizontal_list[0])
                    if result == True:
                        if player == 1:
                            if self.status == "2":
                                self.status = "4"
                ...
                if len(vertical_list[0]) >= z:
                    result = checkConsecutive(vertical_list[0])
                    if result == True:
                        if player == 1:
                            if self.status == "2":
                                self.status = "4"
...
if __name__=="__main__":
    ...
    obj = ConnectZ()
    directory = "C:\\Users\\jcauchi\\Desktop\\Python Scripts\\ConnectZ\\test2\\"
